...
pcd_object = o3d.io.read_point_cloud("3d_construction/outputs/fr3_office_masked_object.pcd")

pcd_office = o3d.io.read_point_cloud("3d_construction/outputs/fr3_office.pcd")
