...
def build_argparser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Maximum frame gap for matching the same instance track.",
    )
    parser.add_argument(
        "--track-iou-threshold",
        type=float,
        default=0.05,
        help="Minimum mask IoU to match a detection to an existing track.",
    )
    parser.add_argument(
        "--track-center-threshold",
        type=float,
        default=120.0,
        help="Maximum 2D center distance in pixels to match a detection to an existing track.",
    )
